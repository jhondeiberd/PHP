...
<html lang="en">
	...
	<body>
		<?php
        //include template "include template/asd.php";    //Warning Message
//        require "require.php";        //PAge will not load. Exception Thrown

        //Absolute Path
            //Root Location:

        // Relative Path: Starting from current directory.
        // Go to Parent Director with ..
        // Current directory .
        include_once "../2/numbers.php";
        ...
        require_once "sections/about_us.php"
        ?>
		...
		<!-- Include all compiled plugins (below), or include template individual files as needed -->
